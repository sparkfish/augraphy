...
The number of points on the geometric plane is set in between 500 and 800. The number of horizontal edge points is set between 5 and 50.
The number of vertical points is set between 5 and 50. The shape (h,w) of the pattern patch is set to 20 which passes through the Original Image like a Sliding Window.
...
::
    ...
    delaunay_pattern = DelaunayTessellation(n_points = (500, 800), 
