    ...
    def __call__(self, image, layer=None, mask=None, keypoints=None, bounding_boxes=None, force=False):
        if force or self.should_run():
            ...
            if self.lens_flare_color == "random":
                ...
                color = np.array([self.lens_flare_color[0]/255, self.lens_flare_color[1]/255, self.lens_flare_color[2]/255],dtype="float")
            ...
            # location of flare
            flare_location = np.array([flare_location[0] / resolution[0] - 0.5, flare_location[1] / resolution[1] - 0.5]).astype("float")
            
            # generate lens flare effect
            self.generate_lens_flare(image_lens_flare, noise_mask_input, color, light_spot_size, resolution, flare_location)
