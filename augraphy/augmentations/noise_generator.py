...
class NoiseGenerator:
    ...
    def generate_clusters_and_samples(self, noise_concentration, max_size):
        ...
        if self.noise_type == 1:
            ...
            n_clusters = (int((noise_concentration[0]) * (max_size/100)), int((noise_concentration[1]) * (max_size/80)))
            n_samples = (int((noise_concentration[0]**0.1) * (max_size*20)), int((noise_concentration[1]**0.1) * (max_size*30))) 
        elif self.noise_type == 4:
            n_clusters = (int((noise_concentration[0]) * (max_size/50)), int((noise_concentration[1]) * (max_size/30)))
        ...
        n_samples_array = [random.randint(n_samples[0], n_samples[1]) 
    ...
    def generate_sparsity_std(self, noise_sparsity, xsize, ysize, max_size):
        ...
        if self.noise_type == 2:
            ...
            center_x = (0, xsize)
            center_y = (0, ysize)
        elif self.noise_type == 3 or self.noise_type == 5 or self.noise_type == 6 or self.noise_type == 7 or self.noise_type == 8:    
    ...
    def generate_points(self, n_samples_array, std, center_x, center_y, xsize, ysize):
        ...
        if self.noise_type == 3:
            ...
            generated_points_x = np.concatenate((generated_points_x_left,generated_points_x_right,generated_points_x_top,generated_points_x_bottom))
            generated_points_y = np.concatenate((generated_points_y_left,generated_points_y_right,generated_points_y_top,generated_points_y_bottom))
    ...
    def generate_noise(self,
        ...
        generated_points_x, generated_points_y = self.generate_points(n_samples_array, std, center_x, center_y, xsize, ysize)
        
        # generate mask
        img_mask = self.generate_mask(noise_background, noise_value, generated_points_x, generated_points_y, xsize, ysize)
...
if __name__ == "__main__":
    ...
    # generate mask of noise
    img_mask_type_1 = noise_generator_type_1.generate_noise(noise_value=(0,128),
                                               noise_background = (255,255),
                                               noise_sparsity = (0.6, 0.7),
                                               noise_concentration = (0.7, 0.8))
    img_mask_type_2 = noise_generator_type_2.generate_noise(noise_value=(0,64),
                                               noise_background = (255,255),
                                               noise_sparsity = (0.5, 0.6),
                                               noise_concentration = (0.7, 0.8))
    img_mask_type_3 = noise_generator_type_3.generate_noise(noise_value=(0,128),
                                               noise_background = (255,255),
                                               noise_sparsity = (0.5, 0.5),
                                               noise_concentration = (0.5, 0.5))
    img_mask_type_4 = noise_generator_type_4.generate_noise(noise_value=(0,50),
                                               noise_background = (255,255),
                                               noise_sparsity = (0.9, 0.9),
                                               noise_concentration = (0.9, 0.9))
    img_mask_type_5 = noise_generator_type_5.generate_noise(noise_value=(0,50),
                                               noise_background = (255,255),
                                               noise_sparsity = (0.5, 0.6),
                                               noise_concentration = (0.5, 0.6))
    img_mask_type_6 = noise_generator_type_6.generate_noise(noise_value=(0,50),
                                               noise_background = (255,255),
                                               noise_sparsity = (0.5, 0.6),
                                               noise_concentration = (0.5, 0.6))
    img_mask_type_7 = noise_generator_type_7.generate_noise(noise_value=(0,50),
                                               noise_background = (255,255),
                                               noise_sparsity = (0.5, 0.6),
                                               noise_concentration = (0.5, 0.6))
    img_mask_type_8 = noise_generator_type_8.generate_noise(noise_value=(0,50),
                                               noise_background = (255,255),
                                               noise_sparsity = (0.5, 0.6),
                                               noise_concentration = (0.5, 0.6))
